const resources = {
  kz: {
    translation: {
      ...
      more: "Толықтыру",
      work: "Презентацияны жүктеу",
      olymp: "Конкурсқа тіркелу",
      link: "3. Презентацияның ссылкасын салыңыз немесе жүктеңіз",
      or: "Немесе",
      errorSend: "Жіберілген жоқ, қайтадан көріңіз",
      form: "1. Нысан (форма) бойынша өтінімді жүктеңіз ",
      form1: "2. Нысан (форма) бойынша өтінімді жіберіңіз",
      clickKaz: "Қазақша нұсқасын жүктеп алу үшін басыңыз",
      clickRus: "Орыс нұсқасын жүктеп алу үшін басыңыз",
      formLink: "Презентацияның ссылкасы",
      ...
      exist: "Бұл Login қолданыста бар, басқасын көріңіз",
      firstName: "Атыңызды енгізіңіз",
      lastName: "Тегіңізді енгізіңіз",
      middleName: "Әкесінің атыңызды енгізіңіз",
      ...
      linkPresentation: "Презентацияның ссылкасы",
      linkArticle: "Мақаланың ссылкасы",
      article: "4. Мақала ссылкасын салыңыз немесе жүктеңіз. (Маңызды емес)",
      skip: "Өткізіп жіберу",
      next: "Келесі",
      res: "Қайтадан жіберу",
      back: "Артқа",
      step: "Қадам",
      of: "ден",
      if: "Маңызды емес, егер болса",
      question1: "Нысан бойынща форманы жіберілген:",
      question2: "Презентация жіберілген:",
      question3: "Мақала жіберілген:",
    },
  },
