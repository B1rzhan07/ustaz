const resources = {
  kz: {
    translation: {
      ...
      link: "3. Презентацияның сілтемесін енгізіңіз немесе файлды жүктеңіз",
      or: "Немесе",
      ...
      formLink: "Презентацияның сілтемесі",
      ...
      linkPresentation: "Презентацияның сілтемесі",
      linkArticle: "Мақаланың сілтемесі",
      article:
        "4. Мақала сілтемесін енгізіңіз немесе файлды жүктеңіз. (Қалау бойынша)",
      skip: "Өткізіп жіберу",
      next: "Келесі",
      res: "Қайтадан жіберу",
      back: "Артқа",
