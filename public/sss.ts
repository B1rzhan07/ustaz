const resources = {
  kz: {
    translation: {
      ...
      san: "Сан енгізіңіз",
      olympReg: "Олимпиадаға тіркелген",
      news: "Жаңалықтар",
      plan: "Оқу жоспарлары",
      read: "Оқу",
    },
  ...
  ru: {
    translation: {
      ...
      san: "Напишите число",
      olympReg: "Регистрация на олимпиаду",
      news: "Новости",
      plan: "Учебные планы",
      read: "Читать",
    },
