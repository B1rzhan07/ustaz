const resources = {
  kz: {
    translation: {
      ...
      link: "2. Презентацияның ссылкасын салыңыз немесе жүктеңіз",
      or: "Немесе",
  ...
  ru: {
    translation: {
      ...
      link: "2. Вставьте ссылку презентаций либо загрузите ее.",
      or: "или",
      errorSend: "Ошибка отправки",
      form: "1. Отправить заявку по форме (форме)",
