const resources = {
  kz: {
    translation: {
      ...
      fast:
        '2023 жылдың 30 наурызыңа дейін тіркелуге және қатысуға өтінім беруге асығыңыз',
      create: 'Байқауды ұйымдастырушы',
      almaty: 'Алматы қаласының Білім басқармасы',
      contact: 'Байланыс деректері',
      come: 'Қатысуға шақырамыз',
      age:
        'Конкурсқа Алматы қаласының мемлекеттік білім беру ұйымдарындағы оқу жоспарының барлық пәндері бойынша 36 жасқа дейін қоса алғанда 1-11 сынып мұғалімдері қатыса алады',
      wifi: 'электрондық тіркеуден өтіп, сауалнаманы толтырыңыз',
      down:
        'түйіндемені, фотосуретті және еңбек өтілі көрсетілген жұмыс орнынан анықтаманың скан-көшірмесін жүктеңіз',
      ...
      link:
        '3. Мультимедиялық мақаланың сілтемесін енгізіңіз немесе файлды жүктеңіз',
      or: 'Немесе',
      ...
      know:
        '«Білім берудегі жаңа технологиялар» саласы бойынша әлемдік қауымдастық мойындаған оқу орнында оқу тағылымдамасы',
      almatys:
      ...
      total2: '2 кезеңнің бағасы',
      works: 'Жіберілген жұмыстар',
      results: 'Нәтижелер',
  ...
  ru: {
    translation: {
      ...
      fast:
        'Заявка на регистрацию и участие до 30 марта 2023 года спешите отдать',
      create: 'Организатор конкурса',
      almaty: 'Управление образования города Алматы',
      contact: 'Контактные данные',
      come: 'Приглашаем принять участие',
      age:
        'В конкурсе могут принять участие учителя 1-11 классов по всем предметам учебного плана в государственных организациях образования города Алматы до 36 лет включительно',
      wifi: 'пройдите электронную регистрацию и заполните анкету',
      down:
        'скачать резюме, фото и скан-копию справки с места работы с указанием стажа работы',
      ...
      know:
        'Учебная стажировка в учебном заведении, признанном мировым сообществом в области новые технологии в образовании»',
      almatys:
      ...
      sum: 'Сумма баллов',
      newOne: 'загрузить КСП',
      upload: 'Выбрать файл',
      newCheck: 'КСП отправлена:',
      total2: 'Результаты 2 этапа',
      works: 'Представленные работы',
      results: 'Результаты',
